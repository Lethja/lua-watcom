...
|--------------------------------------------------------------------------|------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [86Box](https://86box.net/)</br>[PCem](https://www.pcem-emulator.co.uk/) | Full x86 PC Hardware Emulation                                   | https://github.com/86Box/86Box</br>https://github.com/sarah-walker-pcem/pcem/                                                                     | May require firmware binary blobs for emulated PC hardware.                                                                                                                                                                                                                                     |
...
| [MiSTer FPGA](https://mister-devel.github.io/MkDocs_MiSTer/)             | Full x86 PC Hardware Replication (Field Programmable Gate Array) | https://github.com/MiSTer-devel/ao486_MiSTer</br>https://github.com/MiSTer-devel/PCXT_MiSTer</br>https://github.com/MiSTer-devel/Wiki_MiSTer/wiki | Requires compatible field programmable gate array (FPGA) hardware.                                                                                                                                                                                                                              |
